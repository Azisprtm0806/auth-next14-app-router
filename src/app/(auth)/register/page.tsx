    ...
    {error !== '' && <div className="text-red-600 font-bold mb-3">{error}</div>}
      <div
        ...
        <form className="space-y-6" onSubmit={(e) => handleSubmit(e)}>
          ...
          <div>
            <label className="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Full Name</label>
          ...
          <button disabled={loading} type="submit" className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{loading ? "Loading..." : "Singn Up account"}</button>
